    ...
    <?php if (isset($con)) { include_once __DIR__ . '/../functions/auth.php'; } ?>
                ...
                <li id="user-btn" class="main-li dropdown" style="background:none;">
                    <div class="dropdown show">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <?php $adminUser = (isset($con) ? admin_current_user($con) : null); ?>
                            <a class="dropdown-item" href="users.php?do=Edit&user_id=<?php echo htmlspecialchars($adminUser['user_id'] ?? ''); ?>">
                                <i class="fas fa-user-cog"></i>
                                <span style="padding-left:6px">
                                    Edit Profile
                                </span>
                            </a>
                            <?php if (!empty($adminUser) && ($adminUser['role'] ?? '') === 'admin'): ?>
